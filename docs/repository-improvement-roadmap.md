...
- Progress: home and open-house card grids now share one native-link delegation
  ...
  of 2026-07-16.
- Progress: home and open-house card lists now use the shared round-robin column
  packer, preserving independent card heights without row-stretching gaps as of
  2026-07-16.
